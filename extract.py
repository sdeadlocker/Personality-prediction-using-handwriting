...
def straighten(image):
    ...
    print("BASELINE ANGLE at 172",BASELINE_ANGLE)
...
def extractLines(img):
    ...
    # print("LETTER SIZE at 403:",LETTER_SIZE)
    # error prevention ^-^
    ...
    print("LINE SPACING at 411:",LINE_SPACING)
    ...
    print("top margin at 416:",TOP_MARGIN)
...
def extractWords(image, lines):
    ...
    for i, line in enumerate(lines):
        ...
        # print("space zero at 530:",space_zero)

    # print space_zero
    space_columns = np.sum(space_zero)
    # print("space count at 533:",space_count)
    space_count = len(space_zero)
    # print("space count at 535:",space_count)
    print("LETTER SIZE at 539:",LETTER_SIZE)
    if (space_count == 0):
        space_count = 1
    ...
    print("WORD SPACING at 545:",WORD_SPACING)
...
def extractSlant(img, words):
    ...
    if (max_index == 0):
        ...
        SLANT_ANGLE = angle
        print("SLANT ANGLE at 756",SLANT_ANGLE)
    ...
    SLANT_ANGLE = angle
    # print("SLANT ANGLE at 773",SLANT_ANGLE)
    print ("Slant angle(degree): "+str(SLANT_ANGLE)+result)
    print( "************************************************\n")
    return

''' function to convert color image into black and white '''

def convert_to_black_and_white(image, block_size=3, constant=6):
    ...
    # Apply adaptive thresholding to reduce brightness and enhance visibility
    image = cv2.adaptiveThreshold(grayscale_image, 255, cv2.ADAPTIVE_THRESH_MEAN_C, cv2.THRESH_BINARY, block_size, constant)
...
def barometer(image):
    ...
    print("PEN PRESSURE at 813",PEN_PRESSURE)
